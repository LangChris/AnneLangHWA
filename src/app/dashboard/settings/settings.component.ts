...
export class SettingsComponent implements OnInit {
  ...
  generalSettingsForm = new FormGroup({
    ...
    promoActive: new FormControl(this.global.promo == null ? null : this.global.promo.active, [Validators.required]),
    promoType: new FormControl(this.global.promo == null ? null : this.global.promo.type, [Validators.required]),
    promoGift: new FormControl(this.global.promo == null ? null : this.global.promo.gift),
    promoAmount: new FormControl(this.global.promo == null ? null : this.global.promo.amount),
    promoCoverage: new FormControl(this.global.promo == null ? null : this.global.promo.coverage),
    promoCode: new FormControl(this.global.promo == null ? null : this.global.promo.code, [Validators.required]),
    promoEndDate: new FormControl(this.global.promo == null ? null : new Date(this.global.promo.endDateString), [Validators.required]),
